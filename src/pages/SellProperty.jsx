      ...
      <main className="max-w-6xl mx-auto px-6 py-12 text-slate-900">
        ...
        <section className="mb-16">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
              ...
              get the best value for your property. This guide walks you through
              each step with confidence and transparency.
            </p>
            <a
              href="#"
        ...
        <section className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-600 max-w-3xl leading-relaxed mb-6 text-justify">
            The process of selling your property can feel overwhelming, but with
            the right resources, it doesn’t have to be. We are here to make your
            journey from “For Sale” to “Sold” as smooth and successful as
            possible. Here are three tips to make the most of the agent-client
            relationship.
          </p>
            ...
            <article className="bg-white rounded-lg shadow overflow-hidden border">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  The time it takes to sell a property can vary based on market
                  conditions, but no matter how fast or slow the sale moves,
                  avoid entering into negotiations with buyers whom you aren't
                  sure of their source of funds. Some patience and due diligence
                  on your side will help ensure you reach your home-selling
                  goals.
                </p>
              </div>
            </article>
            ...
            <article className="bg-white rounded-lg shadow overflow-hidden border">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  ...
                  leave it all up to them. As a seller, you’ll have a number of
                  personal responsibilities to manage to help make your
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 space-y-6">
              <div className="bg-white rounded-lg p-5 shadow border">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Showcase your property with an online listing that highlights
                  key details and includes high-quality images. These listings
                  instantly grab potential buyers’ attention and make your
                  property stand out.
                </p>
              </div>

              <div className="bg-white rounded-lg p-5 shadow border">
                <h4 className="font-semibold">Advanced Marketing Strategies</h4>
                <p className="mt-2 text-sm text-slate-600">
                  Reach more buyers with Grace Route’s cutting-edge digital
                  marketing tools. With targeted ads and online strategies, your
                  property will get maximum visibility to drive traffic and
                  generate interest.
                </p>
              </div>
