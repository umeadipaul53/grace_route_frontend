...
function PropertyDetails() {
  ...
  return (
    <>
      <Helmet>
        <title>
          {propertyDetail?.property_name || "Property Details"} – Grace Route
          Ltd
        </title>
        <meta
          name="description"
          content={
            propertyDetail?.otherInfo?.slice(0, 160) ||
            "Property details, pricing and features from Grace Route Ltd."
          }
        />
      </Helmet>
