...
function BuyProperty() {
  ...
  return (
    <>
      <Helmet>
        <title>Buy Property – Grace Route Ltd</title>
        <meta
          name="description"
          content="Buy verified land, estates and residential properties through Grace Route Ltd. Secure and trustworthy real estate investment options."
        />
      </Helmet>
      <div>
        <HeroSection
          ...
          <section className="mb-16">
            ...
            <div className="text-center mb-10">
              ...
              <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Buying any property can be one of the most exciting experiences
                of your life. With the right support and the help of a trusted
                agent, you'll make the most informed decisions. This guide walks
                you through each step with confidence.
              </p>
              <Link
                to="/property-listing"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <article className="bg-white rounded-lg shadow overflow-hidden border">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    ...
                    budgets, we have your interest at heart and will always
                    refer you on the best deal that will suit your budget and
                    future plans. Always communicate effectively about budgets,
              ...
              <article className="bg-white rounded-lg shadow overflow-hidden border">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    This may be your first time buying a property — ask
                    questions, rely on our expert experience, and trust the
                    process.
                  </p>
                </div>
              </article>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-lg p-5 shadow border">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Learn about communities on any listing page — local
                    population breakdowns, school ratings, nearby services, and
                    more.
                  </p>
                </div>
